 ...
 */
@Repository("valoriEstensioneDaoImpl")
@Transactional
public class ValoriEstensioneDaoImpl extends GenericDaoImpl<ValoriEstensione, Integer> implements ValoriEstensioneDao {

    public ValoriEstensioneDaoImpl() {
        super(ValoriEstensione.class);
    }

    @Override
    @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
    public List<ValoriEstensione> findAll() {
        return em.createNamedQuery("ValoriEstensione.findAll")
                .getResultList();
    }

    @Override
    @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
    public ValoriEstensione findReferenceById(Integer id) {
        /*
        ...
        */
        return em.getReference(ValoriEstensione.class, id);
    }
