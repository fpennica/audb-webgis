 ...
 */
@Repository("valoriDurataDaoImpl")
@Transactional
public class ValoriDurataDaoImpl extends GenericDaoImpl<ValoriDurata, Integer> implements ValoriDurataDao {

    public ValoriDurataDaoImpl() {
        super(ValoriDurata.class);
    }

    @Override
    @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
    public List<ValoriDurata> findAll() {
        return em.createNamedQuery("ValoriDurata.findAll")
                .getResultList();
    }

    @Override
    @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
    public ValoriDurata findReferenceById(Integer id) {
        /*
        ...
        */
        return em.getReference(ValoriDurata.class, id);
    }
