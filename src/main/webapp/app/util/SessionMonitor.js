 ...
 * logged out.
 * Based on https://market.sencha.com/extensions/extjs-activity-monitor
 */
Ext.define('AUDB.util.SessionMonitor', {
    singleton: true,
    interval: 1000 * 10, // run every 10 seconds.
    lastActive: null,
    maxInactive: 1000 * 60 * 30, // 15 minutes of inactivity allowed; set it to 1 for testing.
    remaining: 0,
    ui: Ext.getBody(),
    /**
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
                ...
                handler: function () {
                    Ext.TaskManager.stop(AUDB.util.SessionMonitor.countDownTask);
                    AUDB.util.SessionMonitor.window.hide();
