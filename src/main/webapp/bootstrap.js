...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.locale.it.Component": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.Basic": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.CheckboxGroup": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.RadioGroup": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.Base": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.ComboBox": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.Date": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.HtmlEditor": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.Number": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.Text": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.Time": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.form.field.VTypes": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.BooleanColumn": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.DateColumn": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.GroupingFeature": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.NumberColumn": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.PropertyColumnModel": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.header.Container": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.grid.plugin.DragDrop": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.picker.Date": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.picker.Month": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.tab.Tab": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.toolbar.Paging": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.view.AbstractView": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.view.View": "ext/locale/ext-lang-it.js",
  "Ext.locale.it.window.MessageBox": "ext/locale/ext-lang-it.js",
...
Ext.ClassManager.addNameAlternateMappings({
  "AUDB.Application": [],
  "AUDB.controller.AllagamentiOsservController": [],
  "AUDB.controller.LoginController": [],
  "AUDB.controller.MainController": [],
  "AUDB.controller.MapController": [],
  "AUDB.controller.ToolsController": [],
  "AUDB.controller.UserController": [],
  "AUDB.model.AllagamentiFoto": [],
  "AUDB.model.AllagamentiOsserv": [],
  "AUDB.model.AllagamentiOsservFonti": [],
  "AUDB.model.GenericComboModel": [],
  "AUDB.model.Progetto": [],
  "AUDB.model.Utente": [],
  "AUDB.model.ValoriDurata": [],
  "AUDB.model.ValoriEstensione": [],
  "AUDB.model.ValoriProfondita": [],
  "AUDB.store.AllagamentiFoto": [],
  "AUDB.store.AllagamentiOsserv": [],
  "AUDB.store.AllagamentiOsservFonti": [],
  "AUDB.store.Comuni": [],
  "AUDB.store.Indirizzi": [],
  "AUDB.store.Progetti": [],
  "AUDB.store.ProgettiUtente": [],
  "AUDB.store.Province": [],
  "AUDB.store.Regioni": [],
  "AUDB.store.User": [],
  "AUDB.store.ValoriDurata": [],
  "AUDB.store.ValoriEstensione": [],
  "AUDB.store.ValoriProfondita": [],
  "AUDB.util.MD5": [],
  ...
  "AUDB.view.Viewport": [],
  "AUDB.view.WestPanel": [],
  "AUDB.view.allagamenti.AllagamentiOsservEditWin": [],
  ...
  "Ext.locale.it.Component": [],
  "Ext.locale.it.form.Basic": [],
  "Ext.locale.it.form.CheckboxGroup": [],
  "Ext.locale.it.form.RadioGroup": [],
  "Ext.locale.it.form.field.Base": [],
  "Ext.locale.it.form.field.ComboBox": [],
  "Ext.locale.it.form.field.Date": [],
  "Ext.locale.it.form.field.HtmlEditor": [],
  "Ext.locale.it.form.field.Number": [],
  "Ext.locale.it.form.field.Text": [],
  "Ext.locale.it.form.field.Time": [],
  "Ext.locale.it.form.field.VTypes": [],
  "Ext.locale.it.grid.BooleanColumn": [],
  "Ext.locale.it.grid.DateColumn": [],
  "Ext.locale.it.grid.GroupingFeature": [],
  "Ext.locale.it.grid.NumberColumn": [],
  "Ext.locale.it.grid.PropertyColumnModel": [],
  "Ext.locale.it.grid.header.Container": [],
  "Ext.locale.it.grid.plugin.DragDrop": [],
  "Ext.locale.it.picker.Date": [],
  "Ext.locale.it.picker.Month": [],
  "Ext.locale.it.tab.Tab": [],
  "Ext.locale.it.toolbar.Paging": [],
  "Ext.locale.it.view.AbstractView": [],
  "Ext.locale.it.view.View": [],
  "Ext.locale.it.window.MessageBox": [],
  "Ext.menu.CheckItem": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "AUDB.util.Util": [],
  "AUDB.ux.form.field.DateDisplayField": [
    "widget.datedisplayfield"
  ],
  "AUDB.view.CenterPanel": [
    "widget.main-tabpanel"
  ],
  "AUDB.view.EastPanel": [
    "widget.main-eastpanel"
  ],
  "AUDB.view.Header": [
    "widget.main-header"
  ],
  ...
  "AUDB.view.WestPanel": [
    "widget.main-westpanel"
  ],
  "AUDB.view.allagamenti.AllagamentiOsservEditWin": [
    "widget.allagamentiosserveditwin"
  ],
  "AUDB.view.allagamenti.AllagamentiOsservForm": [
    "widget.allagamentiosservform"
  ],
  "AUDB.view.allagamenti.AllagamentiOsservIdentForm": [
    "widget.allagamentiosservidentform"
  ],
  "AUDB.view.allagamenti.AllagamentiOsservList": [
    "widget.allagamentiosservlist"
  ],
  "AUDB.view.allagamenti.ReverseGeocodingTrigger": [
    "widget.reversegeocodingtrigger"
  ],
  "AUDB.view.login.LoginWindow": [
    "widget.loginwindow"
  ],
  "AUDB.view.map.LayerTreePanel": [
    "widget.layertreepanel"
  ],
  "AUDB.view.map.LegendPanel": [
    "widget.audb_legendpanel"
  ],
  "AUDB.view.map.MapPanel": [
    "widget.audb-mappanel"
  ],
  "AUDB.view.map.SVPanoramaPanel": [
    "widget.svpanoramapanel"
  ],
  "AUDB.view.tools.AdminMenu": [
    "widget.adminmenu"
  ],
